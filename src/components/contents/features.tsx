...
const Features = () => {
  return (
    <div className="relative flex flex-col items-center justify-center py-20">
      <div className="absolute -top-48 -left-1/5 bg-primary w-72 h-72 rounded-full -z-10 blur-[14rem]"></div>
      ...
      <div className="relative flex flex-col items-center justify-center w-full h-full mt-8">
        ...
        <div className="relative inset-0 z-20 flex flex-col items-center justify-center w-full lg:absolute lg:px-20">
          ...
          <div className="bottom-0 flex items-center w-full mt-20 justify-evenly lg:mt-auto">
            ...
            >
              <h3 className="text-2xl font-medium text-transparent md:text-4xl bg-gradient-to-b from-white to-neutral-500 bg-clip-text">
                40.9k
              </h3>
  ...
  return (
    <div className="flex flex-col items-center justify-center select-none">
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-normal text-neutral-100">{title}</span>
      </div>
    </div>
  );
};
...
const Feature = ({ title, description, icon: Icon }: FeatureProps) => {
  return (
    <div className="flex flex-col items-start justify-start w-full p-4 md:items-center md:justify-center opacity-100 md:p-0">
